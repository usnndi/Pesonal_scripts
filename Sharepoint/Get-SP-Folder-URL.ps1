...
$tenant = 'advemploy' # xxxx.onmicrosoft.com

$tenantId = '6da700ef-06f1-46d5-965a-e6abaec46f25' #Tenant ID, can be retrieved from Azure AD or PowerShell under optional.

$siteName = 'forums' #Sharepoint site name
